...
@Component({
  selector: 'app-cotizaciondedit',
  templateUrl: 'cotDisenoEditorial.html',
  styleUrls: ['cotEstilos.css'],
  providers: [ ObInfoRestService ]
})

export class CotizarDEditComponent {
// creamos un nuevo objeto de form y seteamos su tipo como complexform
  ...
  imp = ['Revistas', 'Catálogos', 'Manuales', 'Diseños', 'Libros', 'Correción de Libros', 'Restauración de Libros',
    'Empastados / Tesis', 'Photobook' ];
...
// pasamos una instancia del FormBuilder a nuestro constructor
  ...
  submitForm(value: any): void {
    /*console.log('Reactive FormData');
     console.log(value);*/
    this.enviarcorreo();
    this.router.navigate(['/services/disenoeditorial']);
  }
